...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \Determine\Service\Guess\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Determine\Service\Guess\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function registerCommand($command){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Determine\Service\Guess\Console\Kernel::registerCommand($command);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Determine\Service\Guess\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Determine\Service\Guess\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Determine\Service\Guess\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Determine\Service\Guess\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Determine\Service\Guess\Console\Kernel::bootstrap();
        }
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \Determine\Service\Guess\User|null 
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \Determine\Service\Guess\User 
         * @static 
         */
